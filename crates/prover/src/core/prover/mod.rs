...
use super::circle_stir::{
    prove_circle_stir_secure_poly, verify_circle_stir_secure_poly, CircleStirSecureFieldProof,
};
...
pub fn prove_circle_stir<B: BackendForChannel<MC>, MC: MerkleChannel>(
    components: &[&dyn ComponentProver<B>],
    channel: &mut MC::C,
    commitment_scheme: &mut CommitmentSchemeProver<'_, B, MC>,
) -> Result<CircleStirSecureFieldProof<MC::H>, String> {
    ...
    let proof = prove_circle_stir_secure_poly(composition_poly);
...
pub fn verify_circle_stir<B: BackendForChannel<MC>, MC: MerkleChannel>(
    proof: CircleStirSecureFieldProof<MC::H>,
) -> bool {
    verify_circle_stir_secure_poly::<B, MC>(proof)
}
